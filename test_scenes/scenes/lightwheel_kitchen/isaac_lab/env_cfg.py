"""
Environment Configuration - kitchen_dish_loading
...
SCENE_ENTITY_MAP = {
    "robot": "/World/Robot",
    "scene_root": "/World/Kitchen",
    "Refrigerator001": "/World/Kitchen/Objects/Refrigerator001",
    "Dishwasher054": "/World/Kitchen/Objects/Dishwasher054",
    "Microwave017": "/World/Kitchen/Objects/Microwave017",
    "Sink054": "/World/Kitchen/Objects/Sink054",
    "Stovetop012": "/World/Kitchen/Objects/Stovetop012",
    "RangeHood015": "/World/Kitchen/Objects/RangeHood015",
    "Kitchen_Cabinet001": "/World/Kitchen/Objects/Kitchen_Cabinet001",
    "Kitchen_Cabinet002": "/World/Kitchen/Objects/Kitchen_Cabinet002",
    "Table049": "/World/Kitchen/Objects/Table049",
    "WallStackOven004": "/World/Kitchen/Objects/WallStackOven004",
    "Toaster003": "/World/Kitchen/Objects/Toaster003",
    "CoffeeMachine006": "/World/Kitchen/Objects/CoffeeMachine006",
    "Pot057": "/World/Kitchen/Objects/Pot057",
}
...
def reward_reaching(
    env,
    target_entity: SceneEntityCfg = SceneEntityCfg("Refrigerator001", prim_path=SCENE_ENTITY_MAP.get("Refrigerator001")),
...
def termination_object_dropped(
    env,
    object_entity: SceneEntityCfg = SceneEntityCfg("Refrigerator001", prim_path=SCENE_ENTITY_MAP.get("Refrigerator001")),
...
class SceneCfg(InteractiveSceneCfg):
    ...
    scene = AssetBaseCfg(
        ...
        spawn=sim_utils.UsdFileCfg(
            usd_path="/Users/nijelhunt_1/workspace/BlueprintPipeline/test_scenes/scenes/lightwheel_kitchen/usd/scene.usda",
            scale=(1.0, 1.0, 1.0),
        ),
    )
    ...
    if "Refrigerator001":
        Refrigerator001 = RigidObjectCfg(
            prim_path=SCENE_ENTITY_MAP.get("Refrigerator001", "/World/Scene/Refrigerator001"),
            spawn=None,
    ...
    class PolicyCfg(ObservationGroupCfg):
        ...
        target_rel_pos = ObservationTermCfg(
            ...
            params={
                ...
                "target_entity": resolve_scene_entity("Refrigerator001")
            },
        )
...
class RewardsCfg:
    ...
    dish_placed = RewardTermCfg(
        func=reward_functions.reward_dish_placed,
        weight=1.0,
    )

    rack_utilization = RewardTermCfg(
        func=reward_functions.reward_rack_utilization,
        weight=1.0,
    )

    collision_penalty = RewardTermCfg(
        func=reward_functions.reward_collision_penalty,
        weight=1.0,
    )

    breakage_penalty = RewardTermCfg(
        func=reward_functions.reward_breakage_penalty,
        weight=1.0,
    )
...
class EventsCfg:
    ...
    dishwasher_state = EventTermCfg(
        func="randomize_dishwasher_state",
        mode="reset",
    )
...
class KitchenDishLoadingEnvCfg(ManagerBasedEnvCfg):
    """Configuration for kitchen_dish_loading environment."""
