...
```
Image Upload → Stage 1 text generation → text-scene-adapter-job → scale-job (optional) → interactive-job
                                                                        ↓
                                                                  simready-job
                                                                        ↓
                                                              usd-assembly-job
...
1. **BlueprintPipeline Generation**: Use Stage 1 text generation for mesh generation
