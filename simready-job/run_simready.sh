...
echo "[SIMREADY] PIPELINE_ENV=${PIPELINE_ENV:-}"
if [[ -n "${SIMREADY_PRODUCTION_MODE:-}" ]]; then
  echo "[SIMREADY] WARNING: SIMREADY_PRODUCTION_MODE is deprecated; use PIPELINE_ENV=production instead." >&2
fi
