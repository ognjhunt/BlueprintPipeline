#!/usr/bin/env python3
"""
Replicator Script: Precision Desk Manipulation
Scene: ChIJBc5E5wTjrIkRKrrWR_meHbc
Policy: dexterous_pick_place

Training for fine motor control picking small items from the desk and nightstand.
...
def setup_replicator():
    """Set up the complete Replicator pipeline for Precision Desk Manipulation."""

    print("[REPLICATOR] Setting up Precision Desk Manipulation...")
    ...
    with rep.new_layer():
        ...
        writer.initialize(
            output_dir=f"./synthetic_data/ChIJBc5E5wTjrIkRKrrWR_meHbc/dexterous_pick_place",
...
if __name__ == "__main__":
    ...
    print(f"[REPLICATOR] Policy: Precision Desk Manipulation")
