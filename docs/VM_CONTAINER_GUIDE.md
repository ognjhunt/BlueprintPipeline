...
| `GENIESIM_MAX_RESTARTS` | Max client-side container restarts per session (default: `10`). Init retries may still be noisy unless separated from the runtime restart budget. | Export before pipeline run |
