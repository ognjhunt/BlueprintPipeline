...
Exporter scene config overrides (applies when writing `scene_config.yaml`):

- `GENIESIM_EPISODES_PER_TASK` (default: `100`, integer ≥ 1)
- `GENIESIM_USE_CUROBO` (default: `true`, boolean)
