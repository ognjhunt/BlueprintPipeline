...
class AIMotionPlanner:
    ...
    ROBOT_CONFIGS = {
        ...
        "g1": {
            ...
            "default_height": 0.35,
            "ee_to_gripper": 0.18,
            "home_position": np.array([0.4, 0.0, 1.0]),
            "home_orientation": np.array([0, 1, 0, 0]),
            "dof": 7,
            "default_joint_positions": np.array([0.0, -0.2, 0.0, -1.2, 0.0, 0.6, 0.0]),
            "joint_limits_lower": np.array([-2.9, -1.6, -2.9, -2.6, -2.9, -1.7, -2.9]),
            "joint_limits_upper": np.array([2.9, 1.6, 2.9, 2.6, 2.9, 1.7, 2.9]),
        },
        "g1_right_arm": {
            "reach": 0.65,
            "gripper_max_width": 0.08,
