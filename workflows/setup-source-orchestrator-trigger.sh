...
RUNPOD_API_KEY_SECRET=${RUNPOD_API_KEY_SECRET:-""}
RUNPOD_GCP_SERVICE_ACCOUNT_JSON_B64_SECRET=${RUNPOD_GCP_SERVICE_ACCOUNT_JSON_B64_SECRET:-""}
OPENAI_API_KEY_SECRET=${OPENAI_API_KEY_SECRET:-""}
BP_GOOGLE_API_KEY_SECRET=${BP_GOOGLE_API_KEY_SECRET:-""}
...
SCENESMITH_PAPER_OPENAI_API=${SCENESMITH_PAPER_OPENAI_API:-"responses"}
SCENESMITH_PAPER_OPENAI_USE_WEBSOCKET=${SCENESMITH_PAPER_OPENAI_USE_WEBSOCKET:-${OPENAI_USE_WEBSOCKET:-1}}
SCENESMITH_PAPER_OPENAI_WEBSOCKET_BASE_URL=${SCENESMITH_PAPER_OPENAI_WEBSOCKET_BASE_URL:-${OPENAI_WEBSOCKET_BASE_URL:-}}
...
WORKFLOW_ENV_KEYS=(
    ...
    TEXT_GEN_VM_NAME
    TEXT_GEN_VM_ZONE
    RUNPOD_API_KEY_SECRET
    RUNPOD_GCP_SERVICE_ACCOUNT_JSON_B64_SECRET
    OPENAI_API_KEY_SECRET
    BP_GOOGLE_API_KEY_SECRET
