...
TEXT_BACKEND_DEFAULT=${TEXT_BACKEND_DEFAULT:-"scenesmith"}
...
SCENESMITH_PAPER_JSON=$(_build_json_blob \
    SCENESMITH_PAPER_BACKEND SCENESMITH_PAPER_MODEL \
...
# These 20 keys go as individual env vars (within the limit)
WORKFLOW_ENV_KEYS=(
    DEFAULT_SOURCE_MODE
