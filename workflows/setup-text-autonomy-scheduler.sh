...
TEXT_AUTONOMY_PROVIDER_POLICY=${TEXT_AUTONOMY_PROVIDER_POLICY:-"openai_primary"}
TEXT_AUTONOMY_QUALITY_TIER=${TEXT_AUTONOMY_QUALITY_TIER:-"premium"}
TEXT_AUTONOMY_ALLOW_IMAGE_FALLBACK=${TEXT_AUTONOMY_ALLOW_IMAGE_FALLBACK:-"false"}
